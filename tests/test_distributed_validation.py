...
class DistributedValidationTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.coordinator.register_worker("worker-a")
        self.coordinator.register_worker("worker-b")

    def test_distributed_join_validation(self) -> None:
        left = [
    ...
    def test_distributed_count_validation(self) -> None:
        rows = [
            {"city": "seattle"},
            {"city": "vancouver"},
            {"city": "seattle"},
